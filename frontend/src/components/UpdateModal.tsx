    ...
    <div className="update-modal-overlay" onClick={status === 'downloading' ? undefined : onClose}>
      <div className="update-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="update-modal-actions">
          {status === 'available' && (
            <>
              <button className="btn btn-primary" onClick={onStartDownload}>立即更新</button>
              <button className="btn btn-secondary" onClick={onManualDownload}>手动下载</button>
          ...
          {status === 'downloaded' && (
            <button className="btn btn-primary" onClick={onInstall}>重启并安装</button>
          )}
          {status === 'error' && (
            <button className="btn btn-primary" onClick={onManualDownload}>手动下载</button>
          )}
        </div>
      </div>
    </div>
